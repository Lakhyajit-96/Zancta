...
export const TOOLS: ToolMeta[] = [
  {
    ...
    privacy: "local",
    processingType: "pdf",
    seoTitle: "Merge PDF Online — Free, No Upload | ZANCTA",
    seoDescription: "Combine multiple PDF files in your browser without uploading. Free, no watermark, no signup, with files processed in this browser.",
  ...
  },
  {
    ...
    privacy: "local",
    processingType: "pdf",
    seoTitle: "Split PDF Online — Extract Pages Locally | ZANCTA",
    seoDescription: "Split PDFs by page range or extract specific pages in your browser. Free, no account required, and no upload for processing.",
  ...
  },
  {
    ...
    privacy: "local",
    processingType: "pdf",
    seoTitle: "Compress PDF Online — Reduce Size Locally | ZANCTA",
    seoDescription: "Reduce PDF file size in your browser with an object-stream rewrite. No upload or server processing, and actual size change is reported.",
  ...
  },
  {
    ...
    privacy: "local",
    processingType: "pdf",
    seoTitle: "Convert PDF to JPG or PNG Online | ZANCTA",
    seoDescription: "Convert PDF pages to JPG, PNG, or WebP images in your browser. Each page becomes a separate image without uploading the PDF.",
  ...
  },
  {
    ...
    privacy: "local",
    processingType: "pdf",
    seoTitle: "Convert Images to PDF Online | ZANCTA",
    seoDescription: "Turn JPG, PNG, or WebP images into one PDF in your browser. Free, no watermark, and no upload required for processing.",
  ...
  },
  {
    ...
    seoTitle: "Compress JPG, PNG, or WebP Online | ZANCTA",
  ...
  },
  {
    ...
    privacy: "local",
    processingType: "image",
    seoTitle: "Convert JPG, PNG, and WebP Online | ZANCTA",
    seoDescription: "Convert between JPG, PNG, and WebP image formats in your browser. Free, no upload, with batch conversion supported.",
  ...
  },
  {
    ...
    privacy: "local",
    processingType: "image",
    seoTitle: "Resize Images by Pixels Online | ZANCTA",
    seoDescription: "Resize images by exact pixel dimensions with aspect-ratio lock. Free, browser-based, and no upload for processing.",
  ...
  },
  {
    ...
    privacy: "local",
    processingType: "image",
    seoTitle: "Remove EXIF and GPS Data from Photos | ZANCTA",
    seoDescription: "Remove EXIF, GPS, and camera metadata from JPG, PNG, and WebP photos in your browser. No upload for processing.",
  ...
  },
  {
    ...
    privacy: "local",
    processingType: "pdf",
    seoTitle: "Extract Text from PDF Online | ZANCTA",
    seoDescription: "Extract and copy embedded text from PDF documents in your browser. No upload for processing; scanned PDFs need OCR.",
  ...
  },
  {
    ...
    privacy: "local",
    processingType: "image",
    seoTitle: "OCR Images Online — Extract Text Locally | ZANCTA",
