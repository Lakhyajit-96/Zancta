...
| [Show HN draft](growth/show-hn.md) | Owner-only draft; not posted by agents |
| [Background removal](decisions/background-removal.md) | Why the tool is deferred |
| [Legal research](decisions/legal-research.md) | Cited research used for public legal pages |
| [OCR licenses](OCR_LICENSE_AUDIT.md) | Third-party OCR asset licenses |
| [GitHub social preview](github-social-preview.md) | How to set the repository image |

Root: [README.md](../README.md), [CONTRIBUTING.md](../CONTRIBUTING.md), [CHANGELOG.md](../CHANGELOG.md), [LICENSE](../LICENSE).
