  ...
  return (
    ...
    >
      ...
      <ContentSection title="Retention and deletion">
        ...
        <p>
          Authenticated account deletion removes the user record and associated cascading application records through the account flow, after attempting to cancel any known Dodo subscription at period end. Cascading records include sessions, OAuth account rows, entitlements, verification, password-reset, and account-deletion tokens, and related payment customer, subscription, and checkout rows.
        </p>
        <p>
