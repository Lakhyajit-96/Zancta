...
export default function PrivacyPage() {
  return <ContentPage eyebrow="/privacy" title="How ZANCTA handles privacy." intro="This page describes current product behavior. It requires review by the responsible legal owner before a commercial launch." visual={<ShieldVisual />}>
