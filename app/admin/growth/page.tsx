  ...
  return (
    <main className="mx-auto max-w-6xl space-y-10 px-6 py-12">
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">Internal admin view — never exposed publicly. Data is live from the database.</p>
      </div>
      ...
      <Section title="Revenue">
        <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
          <Stat label="Total revenue" value={revenueInr} sub="All time, INR" />
