...
export default function HelpPage() {
  return <ContentPage eyebrow="/help" title="How can we help?" intro="Start with the tool page in front of you. It is the source of truth for its accepted formats, limits, and local processing behavior.">
    ...
    <ContentSection title="Accounts and Premium"><p>Local tools do not require an account. Accounts are for authentication and entitlement management. Free and Premium currently use the same tool limits. Payment checkout, paid subscription changes, and cancellation are only available when the configured payment provider is live.</p></ContentSection>
