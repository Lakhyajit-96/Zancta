...
// guidelines (developers.google.com/identity/branding-guidelines) — its use on
// sign-in controls is explicitly permitted by those guidelines.
function GoogleMark() {
  return (
    <svg width="18" height="18" viewBox="0 0 48 48" aria-hidden="true" focusable="false" data-testid="google-mark">
...
// GitHub: the official github-mark Octocat (github.com/logos, CC-BY-4.0),
// monochrome treatment per GitHub's logo guidance — fill inherits the button
// text color so it stays legible on the dark Boundary surface.
function GitHubMark() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" focusable="false" data-testid="github-mark">
